      ...
      <div className="z-10 text-center max-w-5xl mx-auto space-y-12 w-full">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col items-center gap-6">
             ...
             {/* GitHub Button */}
             <Link href="https://github.com/RealEngineers-ai/candidateai" target="_blank" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors border-b border-white/20 hover:border-white pb-0.5">
